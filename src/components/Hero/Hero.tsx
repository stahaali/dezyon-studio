...
const BannerLineAnimation = dynamic(
  () =>
    import("@/components/Shared/BannerLineAnimation/BannerLineAnimation").then(
      (module) => module.BannerLineAnimation
    ),
  { ssr: false }
);
              ...
              >
                <span className={splitTitleStyles.lightOnDark}>
                  <span className={styles.titleLine1}>
                    ...
                    <HeroTypewriterHighlight
                      phrases={heroContent.typewriterPhrases}
                    />
                  </span>
